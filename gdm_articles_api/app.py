...
from gdm_articles_api.blueprint_development import development
from gdm_articles_api.config import init_config
from gdm_articles_api.helper.cli import add_cli_command
...
def create_app(
    ...
    app.register_blueprint(api_blueprint, url_prefix="/gdm/v1")
